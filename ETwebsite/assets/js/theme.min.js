...
const messages = [
    "Get Dealer quality service in days, not weeks, and for thousands of dollars less!",
    "Come Celebrate Elevated Transmission's 2024 Grand Opening - Get 10% All Services (Parts & Labor)!",
    "First Responders, Veterans and Seniors - Get An Additional 5% Off All Services!",
    "Local Family Owned & Operated!",
    "Quality Workmanship, Quick Turnaround, Fair Prices!",
    "Our employees are salaried and never paid a commission!",
    "Our MEGA-LIFT Bay is 14' at the door - 22' ceiling height, handling vehicles up to 30K & 36' long!"
];

let currentIndex = 0;

function rotateBanner() {
    bannerMessage.textContent = messages[currentIndex];
